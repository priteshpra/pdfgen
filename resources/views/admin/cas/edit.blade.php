    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.cas.update', $user->id) }}">
            ...
            <div class="row">
                ...
                <input id="user_type" type="hidden" class="form-control @error('user_type') is-invalid @enderror" name="user_type" value="4" required autocomplete="name">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <fieldset class="controls">
                            <input name="firm_type" type="radio" id="radio_1" value="Proprietary" {{ (old('firm_type',$user->firm_type ?? "") == 'Proprietary' ) ? 'checked=""' : ''  }} tabindex="14">
                            <label for="radio_1">Proprietary</label>
                            <div class="help-block"></div>
                        </fieldset>
                        <fieldset>
                            <input name="firm_type" type="radio" id="radio_2" {{ (old('firm_type',$user->firm_type ?? "") == 'Private Limited' ) ? 'checked=""' : ''  }} value="Private Limited" tabindex="15">
                            <label for="radio_2">Private Limited</label>
                        </fieldset>
                        <fieldset>
                            <input name="firm_type" type="radio" id="radio_3" value="LLP" {{ (old('firm_type',$user->firm_type ?? "") == 'LLP' ) ? 'checked=""' : ''  }} tabindex="16">
