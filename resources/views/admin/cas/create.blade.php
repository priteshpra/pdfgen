    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.cas.store') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <label for="name" class="required col-md-4 col-form-label text-md-right">{{ __('First Name') }}</label>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="controls">
                        <input id="lname" type="text" class="form-control @error('lname') is-invalid @enderror" name="lname" value="{{ old('lname') }}" required autocomplete="name">
