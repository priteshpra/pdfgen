            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="{{ route('admin.cas.create') }}" class="waves-effect waves-circle btn btn-circle btn-success btn-lg mb-5"><i class="fa fa-plus" aria-hidden="true"></i></a>
                        @endcan
                    </div>
                </div>
            </div>
                                    ...
                                    <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endcan -->
                                                @can('user_edit')
                                                <a href="{{ route('admin.cas.edit', $user->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                                @endcan
                                                <!-- @can('user_delete')
