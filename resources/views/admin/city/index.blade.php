        ...
        <div class="container-full">
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="me-auto">
                        <h3 class="page-title">Citys</h3>
                    </div>
                    <div class="pull-right">
                        @can('city_create')
                        <!-- <a href="{{ route('admin.city.create') }}" class="waves-effect waves-circle btn btn-circle btn-success btn-lg mb-5">Add New City</a> -->
                        <a href="{{ route('admin.city.create') }}" class="waves-effect waves-circle btn btn-circle btn-success btn-lg mb-5"><i class="fa fa-plus" aria-hidden="true"></i></a>
                        @endcan
                    </div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endcan -->
                                                    @can('user_edit')
                                                    <a href="{{ route('admin.city.edit', $user->CityID) }}" class="btn btn-sm btn-warning">Edit</a>
                                                    @endcan
                                                    <!-- @can('user_delete')
