            ...
            <div class="content-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="{{ route('admin.cms.create') }}" class="waves-effect waves-circle btn btn-circle btn-success btn-lg mb-5"><i class="fa fa-plus" aria-hidden="true"></i></a>
                        @endcan
                    </div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endcan -->
                                                    @can('user_edit')
                                                    <a href="{{ route('admin.cms.edit', $user->CMSID) }}" class="btn btn-sm btn-warning">Edit</a>
                                                    @endcan
                                                    <!-- @can('user_delete')
