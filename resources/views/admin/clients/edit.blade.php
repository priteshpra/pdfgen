    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.client.update', $user->id) }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <label for="GSTNumber" class="required col-md-4 col-form-label text-md-right">{{ __('GSTNumber
                        Number')
                        }}</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <fieldset class="controls">
                            <input name="FirmType" type="radio" id="radio_1" value="Proprietary" required="" {{
                                (old('FirmType',$user->FirmType ?? "") == 'Proprietary' ) ? 'checked=""' : '' }}
                            tabindex="14">
