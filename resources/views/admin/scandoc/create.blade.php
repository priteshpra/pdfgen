...
<div class="card">
    <div class="card-header">{{ __('Add New Scan Document') }}</div>

    <div class="card-body">
        <form method="POST" id="update-password-form" action="{{ route('admin.scandocument.store') }}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="controls">
                        <input id="Remarks" type="text" class="form-control @error('Remarks') is-invalid @enderror"
                            name="Remarks" value="{{ old('Remarks') }}" required autocomplete="name">
